...
public class HomeActivity extends AppCompatActivity {  //Base class = AppCompactActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent= new Intent(this,UploadedLogListActivity.class);  // operation to be performed
